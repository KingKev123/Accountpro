...
if __name__ == '__main__':
    ...
    print("🚀 Starting AccountPro - Professional Account Management System")
    print(f"📍 Running on port {port}")
    print("📊 Dashboard available at: /")
    print("👥 Accounts available at: /accounts")
    print("🔍 API endpoints available at: /api/")
    
    # Railway requires 0.0.0.0 and PORT from environment
